  ...
  const mint = async () => {
    ...
    try {
      ...
      setMintInfo((prevState) => ({
        ...
        loading: false,
        status:
          "Cool your CAT Meong will show up on Opensea, once the transaction is successful.",
      }));
      getSupply();
    } catch (err) {
      setMintInfo((prevState) => ({
    ...
    <div className="page">
      <div className="card">
        ...
        <a
          ...
          className="_90"
          target="_blank"
          href="https://rinkeby.etherscan.io/address/0x98d718c03075c706bb4c04c2fcf2a89e5231fc5a"
        >
          View Contract
        </a>
      </div>
